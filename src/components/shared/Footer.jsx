...
const Footer = () => {
  return (
    <footer className='w-full bg-black px-4 py-10 sm:px-6 lg:px-8'>
      <div className='text-center'>
        <div>
          <Link
            href='/'
            className='flex-none text-3xl font-bold text-white dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'
          >
            Cozy Cribs
          </Link>
        </div>
        ...
        <div className='mt-3'>
          ...
          <p className='text-gray-500'>© Cozy Cribs. All rights reserved.</p>
        </div>
